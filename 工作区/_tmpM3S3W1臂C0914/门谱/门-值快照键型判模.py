# -*- coding: utf-8 -*-
r"""门-值快照键型判模.py — M3 S3 W1臂C 课时06B 练习件·值快照逐字零漂＋键型两档＋全线括线判模断言。
照抄 母版门谱同构，换 PIECE/SIDE/MANIFEST；本片批B补 16 键答案侧值均为实值（无「证明见详解．」），
PROC＝空集＝16 键全 值型逐字全等档。值台账底稿落盘本目录。
用法: python 门-值快照键型判模.py    退出码: 0＝全过；1＝有红。
"""
import fitz  # pymupdf
import io
import json
...
SIDE = 'C:/提示词/工作区/M3-第2章量产0913/成卷/题面库/课时06B-2.2.4点到直线距离-答案侧.md'
