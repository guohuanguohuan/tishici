# -*- coding: utf-8 -*-
"""目验v10：v10 包 6 页全页渲染（同 v9 六图规格：A4 150dpi；测评卷 p2＝横向大页）。
页映射（与 v9 同＝21 页）：封面 p1／导学件 p1＝包 p2／导学件 p3＝包 p4／册 v1 p1＝包 p7／
答案册样张 p1＝包 p13／测评卷 p2＝包 p16。"""
import os

import pymupdf

SRC = r'C:\提示词\工作区\字替对照-0909\靠齐样张-0910\靠齐样张包-v10-21页0911.pdf'
