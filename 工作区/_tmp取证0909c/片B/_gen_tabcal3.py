# -*- coding: utf-8 -*-
"""生成 _tabcal3.tex（表2 内容：单行格 共线行 E/struts 标定；临时产物仅本目录）。"""
rows = [
...
variants = [
    ('Y1', '1.5mm', '4.35mm', '0.45mm', '', '0.45mm'),
    ('Y2', '1.5mm', '6.35mm', '0.45mm', '', '0.45mm'),
    ('Y3', '1.5mm', '8.35mm', '0.45mm', '', '0.45mm'),
    ('Y4', '1.5mm', '10.35mm', '0.45mm', '', '0.45mm'),
]
...
for name, E, G, Gh, pre, lG in variants:
    out.append(r'\noindent\textbf{' + name + r' E=' + E + r' G=' + G + r' Gh=' + Gh + r' lG=' + lG + r'}\par')
    out.append(r'\setlength{\extrarowheight}{' + E + '}')
    out.append(table(E, G, Gh, pre, lG))
    out.append(r'\par\vspace{6mm}')
out.append(r'\end{document}')
open('_tabcal3.tex', 'w', encoding='utf-8').write('\n'.join(out))
print('written _tabcal3.tex')
