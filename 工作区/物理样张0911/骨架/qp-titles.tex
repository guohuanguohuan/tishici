% ============================================================
% 【物理骨架 0911｜零参数继承件】本文件＝数学 L1 原样继承，未改任何字号/级距。
%   来源＝工作区/字替对照-0909/靠齐样张-0910/测评卷/qp-titles.tex（md5 edf1c99c…）。
%   物理标题层级映射（件侧用词，不改本件宏）：章＝册章节大标题 20.67pt；节＝「11.3 实验：…」
%   16.88pt；小节＝三级讲标题（2.1 楞次定律：××）15.1pt；课时＝第N课时 13.0pt。
% ============================================================
