% ============================================================
% 【物理骨架 0911｜继承件】＝数学 L1 答案册块宏原样继承（来源
%   工作区/字替对照-0909/靠齐样张-0910/答案册/qp-answ-blocks.tex，md5 c6025f1b…）。
%   答案册件条款①同构同号/②层级缩进 5.0mm/③六条改进随此继承；物理增量（C3 多值读数
%   「41.20/1.199##1.200##」并列形制）在试点件内按样本验证，暂不落本件宏。
%   答案册配图＝位图，用 qp-figs.tex 的 \qpfig 族（经 \ansfig 包一层居中）。
% ============================================================
