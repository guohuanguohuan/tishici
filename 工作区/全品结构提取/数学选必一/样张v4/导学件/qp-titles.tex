...
%   小深块（下探 2.8mm），union 13.8×16.6mm；章名 22pt \heizhang（字重阶梯 4.0×）与方块间距 3.1mm；
...
% 章名 22pt \heizhang 距方块 3.1mm；横线 0.2pt（原 0.4pt，总账B）
...
\newcommand{\mubiaomu}[2]{\noindent\hangindent=8.3mm\hangafter=1
  {\fontsize{10.5pt}{17pt}\selectfont\kaishu\hspace*{2em}{\heitiao #1.}\hspace{1em}#2\par}}
