# -*- coding: utf-8 -*-
r"""门-守恒对号.py — M3 S3 W1 臂B 练习件（课时04＋05）·答案块守恒断言（双档）＋对号门＋拓区隔离＋尾块门＋页数门。
承母版 工作区/_tmpM3S3母版0914/门谱/门-守恒对号.py 复刻，PIECE/MANIFEST 改本臂两片参数化。
用法: python 门-守恒对号.py 课时04|课时05
