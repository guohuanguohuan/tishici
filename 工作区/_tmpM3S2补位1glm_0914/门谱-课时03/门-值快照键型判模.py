...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), '值台账底稿-课时03.json')
NKEYS = 21
THRESH = 8  # 承重墙：估高行数 >THRESH 才转括线
RULED = {'2章-练-课时03-E2', '2章-练-课时03-E6', '2章-练-课时03-E7', '2章-练-课时03-E8'}
# 清洗制：tex 侧为版面加的零墨记号 → 剔除后须与答案侧逐字全等
NORM = {}
# 印面装配序：探究点一 E3,E1,E2,E4,E5,E12,E15→1—7；探究点二 E8,E11,E14,E13→8—11；
#   探究点三 E6,E7,E9,E10,E16→12—16；课堂评价 G1—G5→17—21
NUM = ('2章-练-课时03-E3:1,2章-练-课时03-E1:2,2章-练-课时03-E2:3,'
       '2章-练-课时03-E4:4,2章-练-课时03-E5:5,2章-练-课时03-E12:6,'
       '2章-练-课时03-E15:7,2章-练-课时03-E8:8,2章-练-课时03-E11:9,'
       '2章-练-课时03-E14:10,2章-练-课时03-E13:11,2章-练-课时03-E6:12,'
       '2章-练-课时03-E7:13,2章-练-课时03-E9:14,2章-练-课时03-E10:15,'
       '2章-练-课时03-E16:16,2章-导-课时03-G1:17,2章-导-课时03-G2:18,'
       '2章-导-课时03-G3:19,2章-导-课时03-G4:20,2章-导-课时03-G5:21')
