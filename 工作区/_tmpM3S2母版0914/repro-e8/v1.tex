...
% ans:2章-练-课时01-E8
\ansitem{6}{证明见详解．}
\ansnote{详解}{由两点间距离公式：\par \(|AB|=\sqrt{(3+1)^{2}+(3-3)^{2}}=\sqrt{16}=4\)；\par \(|AC|=\sqrt{(1+1)^{2}+(2\sqrt{3}+3-3)^{2}}=\sqrt{4+12}=4\)；\par \(|BC|=\sqrt{(1-3)^{2}+(2\sqrt{3}+3-3)^{2}}=\sqrt{4+12}=4\)．\par 所以\(|AB|=|AC|=|BC|\)，故\(\triangle ABC\)是等边三角形．}
\end{ansblock}
\end{document}
