# -*- coding: utf-8 -*-
r"""门-守恒对号-课时13.py — M3 S3 W3臂F 课时13 练习件·答案块守恒断言（双档）＋对号门＋拓区隔离＋尾块门＋页数门。
（照抄臂F 课时12 门谱 工作区/_tmpM3S3W3臂F0914/门谱/门-守恒对号-课时12.py，
PIECE/MANIFEST 常量换片，断言面零改动。）
用法: python 门-守恒对号-课时13.py   退出码: 0＝全过；1＝有红。红线：件树与题面库/定稿只读，本脚本零写入。
"""
import io
import json
import os
