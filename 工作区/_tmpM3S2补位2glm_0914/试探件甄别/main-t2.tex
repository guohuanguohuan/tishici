...
\bindp {\kaishu ③收束：截距式丢过原点与平行于轴的直线，须补检验；源卷结果与题面数据互斥时按“源错必改”回代双向验证并留注记.}
...
\bindp {\kaishu ③收束：包络型问题须辨“过定点”与“与定圆相切”两类直线系，二者命题结论完全不同；多解情形（内切、外切两型）逐一取面积，勿漏第二值.}
...
% ============================================================
\begin{ketang}{本组共5题（第20—24题），20—22为单选，23—24为填空．}

\jiancestem{{\fontsize{11.4pt}{14pt}\selectfont\heihao {\numboldjian 20}．}\hspace{4.1mm}\tieside{简单(知识点二)}\hspace{2.2mm}直线\(-x/2+y/3=-1\)在\(x\)轴、\(y\)轴上的截距分别为\nobreak(\kongwei)}

\bindopt {\fontsize{10.5pt}{\qpTJgLeadPingjia}\selectfont \makebox[\dimexpr0.25\linewidth-0.5em\relax][l]{A．2,3}\makebox[\dimexpr0.25\linewidth-0.5em\relax][l]{B．\(-2,3\)}\makebox[\dimexpr0.25\linewidth-0.5em\relax][l]{C．\(-2,-3\)}\makebox[\dimexpr0.25\linewidth-0.5em\relax][l]{D．\(2,-3\)}\par}
...
\jiancestem{{\fontsize{11.4pt}{14pt}\selectfont\heihao {\numboldjian 21}．}\hspace{4.1mm}\tieside{简单(知识点三)}\hspace{2.2mm}直线\(Ax+By+C=0\)（\(A^{2}+B^{2}\neq0\)）经过第二、三、四象限，则\(A\)，\(B\)，\(C\)需满足条件\nobreak(\kongwei)}

\bindopt {\fontsize{10.5pt}{\qpTJgLeadPingjia}\selectfont \makebox[\dimexpr0.5\linewidth-1em\relax][l]{A．\(C=0\)，\(AB<0\)}\makebox[\dimexpr0.5\linewidth-1em\relax][l]{B．\(AC<0\)，\(BC<0\)}\par}

\bindopt {\fontsize{10.5pt}{\qpTJgLeadPingjia}\selectfont \makebox[\dimexpr0.5\linewidth-1em\relax][l]{C．\(A\)，\(B\)，\(C\)同号}\makebox[\dimexpr0.5\linewidth-1em\relax][l]{D．\(A=0\)，\(BC<0\)}\par}
...
\jiancestem{{\fontsize{11.4pt}{14pt}\selectfont\heihao {\numboldjian 22}．}\hspace{4.1mm}\tieside{简单(知识点三)}\hspace{2.2mm}已知直线\(Ax+By+C=0\)的斜率为5，且\(A-2B+3C=0\)，则该直线方程为\nobreak(\kongwei)}

\bindopt {\fontsize{10.5pt}{\qpTJgLeadPingjia}\selectfont \makebox[\dimexpr0.5\linewidth-1em\relax][l]{A．\(15x-3y-7=0\)}\makebox[\dimexpr0.5\linewidth-1em\relax][l]{B．\(15x+3y-7=0\)}\par}

\bindopt {\fontsize{10.5pt}{\qpTJgLeadPingjia}\selectfont \makebox[\dimexpr0.5\linewidth-1em\relax][l]{C．\(3x-15y-7=0\)}\makebox[\dimexpr0.5\linewidth-1em\relax][l]{D．\(3x+15y-7=0\)}\par}
...
\jiancestem{{\fontsize{11.4pt}{14pt}\selectfont\heihao {\numboldjian 23}．}\hspace{4.1mm}\tieside{简单(知识点二)}\hspace{2.2mm}已知直线\(l\)与\(x\)、\(y\)轴所围成的面积为\(1/4\)，则\(l\)的方程可以是\kongbai{}．}
\xiexwei{7mm}
...
\jiancestem{{\fontsize{11.4pt}{14pt}\selectfont\heihao {\numboldjian 24}．}\hspace{4.1mm}\tieside{简单(知识点三)}\hspace{2.2mm}已知直线\(l_1\)：\(2x+y+2=0\)与\(l_2\)：\(4x+by+c=0\)关于点\(P(1,0)\)对称，则\(b+c=\)\kongbai{}．}
\xiexwei{7mm}
...
% ---- 尾块（\tailfill[26mm] 置 \end{multicols} 前；无参＝内容尾随框，件侧不擅自定高） ----
\tailfill
