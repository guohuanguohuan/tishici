...
# P1 副本唯一改（S5-W4 阶段二 M2/P1 臂 2026-09-14）：签名带补物理卷页脚签「高中物理／必修第三册／RJ」
#   （父目录正本 FOOT_RE 按数学卷 RJB 签写，P1 测评本页脚行 y0≈271.4∈脚带被误计入体墨，实测 _dbg3 举证）；三腿逻辑与判线 267.6 零改。
FOOT_RE = re.compile(r'羿郭工作室|测评卷|滚动卷|高中数学|单元素养测评卷|选择性必修|RJB|高中物理|必修第三册|^RJ$|^卷\s*\d+$|^卷$|^\d{1,3}$|^[）(（]$|^[A-G]$')
