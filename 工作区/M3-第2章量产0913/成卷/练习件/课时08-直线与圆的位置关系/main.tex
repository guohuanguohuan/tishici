...
%   一＝直线与圆的位置关系、二＝圆的切线、三＝弦长与圆心角（S4 印前回核 0914：原贴系
%   tjdnr 讲练节序，与 zsd 知识导学分册二/三异序，弦长/切线两域 11 席已按 zsd 改号）。
...
\tihao{1}\zu{圆的弦长问题×单选} \tieside{简单(知识点三)}直线\(l\)：\(3x+4y-1=0\)被圆\(C\)：\(x^{2}+y^{2}-2x-4y-4=0\)所截得的弦长为\nobreak(\kongwei)
...
\tihao{2}\zu{圆的弦长问题×单选} \tieside{中档(知识点三)}已知圆\(x^{2}+y^{2}=9\)的弦过点\(P(1,2)\)，当弦长最短时，该弦所在直线方程为\nobreak(\kongwei)
...
\tihao{3}\zu{圆的弦长问题×单选} \tieside{简单(知识点三)}若圆\(x^{2}+y^{2}-2x+4y+m=0\)截直线\(x+y-3=0\)所得弦长为2，则实数\(m\)的值为\nobreak(\kongwei)
...
\tihao{4}\zu{圆的弦长问题×单选} \tieside{中档(知识点三)}直线\(l\)：\(y=x+m\)与圆\(x^{2}+y^{2}=4\)相交于\(A\)，\(B\)两点，若\(|AB|\geqslant 2\sqrt{3}\)，则实数\(m\)的取值范围为\nobreak(\kongwei)
...
\tihao{6}\zu{圆的切线方程×单选} \tieside{简单(知识点二)}与圆\(x^{2}+y^{2}-4x+3=0\)相切，且在\(x\)、\(y\)轴上截距相等的直线共有\nobreak(\kongwei)
...
\tihao{7}\zu{圆的切线方程×单选} \tieside{简单(知识点二)}若过点\((2,1)\)的圆与两坐标轴都相切，则圆心到直线\(2x-y-3=0\)的距离为\nobreak(\kongwei)
...
\tihao{9}\zu{圆的切线方程×单选} \tieside{中档(知识点二)}过直线\(y=2x-3\)上的点作圆\(C\)：\(x^{2}+y^{2}-4x+6y+12=0\)的切线，则切线长的最小值为\nobreak(\kongwei)
...
\tihao{10}\zu{圆的切线方程×单选} \tieside{简单(知识点二)}已知直线\(l\)：\(x+ay-1=0\)是圆\(C\)：\(x^{2}+y^{2}-6x-2y+1=0\)的对称轴，过点\(A(-1,a)\)作圆\(C\)的一条切线，切点为\(B\)，则\(|AB|=\)\nobreak(\kongwei)
...
\tihao{14}\zu{圆的切线方程×填空} \tieside{简单(知识点二)}若斜率为\(\sqrt{3}\)的直线与\(y\)轴交于点\(A\)，与圆\(x^{2}+(y-1)^{2}=1\)相切于点\(B\)，则\(|AB|=\)\kongda{√3}．
...
\tihao{15}\zu{圆的切线方程＋弦长综合×解答} \tieside{中档(知识点二)}已知点\(M(3,1)\)，直线\(ax-y+4=0\)及圆\(C\)：\((x-1)^{2}+(y-2)^{2}=4\)．
(1) 求过点\(M\)的圆\(C\)的切线方程；
...
\tihao{16}\zu{阿波罗尼斯圆问题×解答} \tieside{中档(知识点二)}为了保证我国东海油气田海域的海上平台的生产安全，海事部门在某平台\(O\)的正东方向设立了两个观测站\(A\)、\(B\)（点\(A\)在点\(O\)、点\(B\)之间），它们到平台\(O\)的距离分别为3海里和12海里，记海平面上到两观测站距离\(PA\)、\(PB\)之比为\(1/2\)的点\(P\)的轨迹为曲线\(E\)，规定曲线\(E\)及其内部区域为安全预警区．
