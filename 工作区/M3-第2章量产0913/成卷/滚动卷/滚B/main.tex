...
% 卷式：单选 6×5＝30｜多选 3×5＝15（全对5/部分2/有错0）｜填空 3×5＝15｜解答 8+10+10+12＝40。
...
\newcommand{\dabiao}{%
  ...
  答案 & B & B & A & C & A & A & C & ACD & AD & \(x^{2}\!-\!\frac{y^{2}}{4}\!=\!1\) & \(y^{2}\!=\!2x/12x/6x\) & \(4\) & 略 & 略 & 略 & 略 \\ \hline
  \end{tabular}}\par}
...
\newpage
% ===================== 第 2 页：栏1 组行三＋Q10–Q12；栏2 组行四＋Q13–Q15；栏3 Q16＋速查表 =====================
\jpthree{\jplead
  ...
  \anskey{2章-滚B-1}\anskey{2章-滚B-2}\anskey{2章-滚B-3}\anskey{2章-滚B-4}\anskey{2章-滚B-5}\anskey{2章-滚B-6}\anskey{2章-滚B-7}\anskey{2章-滚B-8}\anskey{2章-滚B-9}\anskey{2章-滚B-10}\anskey{2章-滚B-11}\anskey{2章-滚B-12}\anskey{2章-滚B-13}\anskey{2章-滚B-14}\anskey{2章-滚B-15}\anskey{2章-滚B-16}
  \fi
}
