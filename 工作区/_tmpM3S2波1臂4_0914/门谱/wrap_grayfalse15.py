# -*- coding: utf-8 -*-
"""wrap_grayfalse15.py — 课时15 判模门首轮读数 est>8 键 ansblock 加 {\ansblockgrayfalse ...} 包装。
适配自臂4 wrap_grayfalse.py（课时14 版）：DIR/KEYS→课时15（括线键-课时15.json）。
...
DIR = 'C:/提示词/工作区/M3-第2章量产0913/成卷/导学件/课时15-2.7.1抛物线方程'
