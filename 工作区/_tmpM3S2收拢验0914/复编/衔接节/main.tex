...
\bindopt {\fontsize{10.5pt}{\qpTJgLeadPingjia}\selectfont \makebox[\dimexpr0.5\linewidth-1em\relax][l]{A．相交}\makebox[\dimexpr0.5\linewidth-1em\relax][l]{B．相切}\par}
\bindopt {\fontsize{10.5pt}{\qpTJgLeadPingjia}\selectfont \makebox[\dimexpr0.5\linewidth-1em\relax][l]{C．相离}\makebox[\dimexpr0.5\linewidth-1em\relax][l]{D．不能确定}\par}
