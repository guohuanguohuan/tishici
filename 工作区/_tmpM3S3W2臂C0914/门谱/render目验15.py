# -*- coding: utf-8 -*-
"""render目验15.py — 课时15 双档 PDF→PNG（150dpi）；true 入片 png/，双档入 过程件/目验PNG/{true,false}/。
照 母版门谱/render目验.py 同制，改 PIECE/PROC 指向课时15／臂C 过程件。"""
import glob
import os
...
PROC = 'C:/提示词/工作区/_tmpM3S3W2臂C0914/目验PNG'
