...
\tihao{11}\zu{W7 空间四边形中点链化简×计算题组} \tieside{简单}如果\(\overrightarrow{a}\)，\(\overrightarrow{b}\)都是空间向量，判断\(\bigl|\,|\overrightarrow{a}|-|\overrightarrow{b}|\,\bigr|\leq|\overrightarrow{a}+\overrightarrow{b}|\leq|\overrightarrow{a}|+|\overrightarrow{b}|\)是否成立，并说明等号何时成立．
\xiexwei{50mm}
