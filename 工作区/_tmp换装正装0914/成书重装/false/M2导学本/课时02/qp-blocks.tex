...
% 全品对齐0911 \zhentib：判断题正文式（全品 p04 实拍：题干右挂全角空括号（　）、不印答案解析；同款见 variantF/qp-blocks）
% v10-A 同款宏同修（沿 v9 排版病轮「导学增量同款宏同修」纪律）：句尾后开廉价断点（\penalty0），
% 断点与 fil 胶间 \hbox{}＋\nobreak 封死丢胶支路——题干完整收行，（　）独落次行仍由 fil 右对齐贴栏。
