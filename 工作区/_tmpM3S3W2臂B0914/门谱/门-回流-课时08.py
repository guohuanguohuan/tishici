# -*- coding: utf-8 -*-
r"""门-回流-课时08.py — M3 S3 W2臂B 课时08 练习件·回流门（零强制跳页）＋件型纪律断言。
...
用法: python 门-回流-课时08.py     退出码: 0＝全过；1＝有红。
"""
import io
import json
import os
...
check('\\liubai 逐题高度 16~40mm 带内（32mm×1 三问＋24mm×1 两问）',
      inband and liubai_h == ['32mm', '24mm'], f'{liubai_h}')
