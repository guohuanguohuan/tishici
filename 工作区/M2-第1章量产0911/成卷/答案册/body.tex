...
% ============================================================
\setcounter{page}{1}   % 独立册起页 1；装配轮按四本跨本连续页码（G7）改写
\par\nointerlineskip
...
\vskip 0pt minus 1.2pt
\ansline{解析}{C 项所涉夹角实算 \(\cos\langle\overrightarrow{B_{1}C},\overrightarrow{AA_{1}}\rangle=-\dfrac{1}{2}\)，夹角恰 \(120^{\circ}\)——讲部详解 \(120^{\circ}\) 正确（2026-09-12 逻辑闸撤销 S2 改字义务：S2 亲算 \(|B_{1}C|=6\sqrt{2}\) 系误算，实 \(|B_{1}C|=6\)，经盲解＋numpy 坐标三重验证）；C 项不正确系其另有错点，键 B 与结论不变。}
\vskip 0pt minus 1.2pt
% pair:导-课时03-评1
% pair:导-课时03-评2
% pair:导-课时03-评3
