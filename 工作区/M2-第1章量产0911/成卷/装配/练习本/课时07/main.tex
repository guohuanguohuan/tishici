...
\par\vspace{1.9mm}\penalty10000\noindent\makebox[\linewidth][c]{\includegraphics[width=30mm]{figs/dy6_image22.png}}\par\vspace{-1.0mm}\penalty-50
...
\par\vspace{1.9mm}\penalty10000\noindent\makebox[\linewidth][c]{\includegraphics[width=38mm]{figs/dy3_image6.png}}\par\vspace{-1.0mm}\penalty-50
\xiexwei{16mm}

\dangbadge{综}{合}{提}{升}

\tihao{11}\zu{K9 线面平行＋面面平行·法向量判定证明（双判据门面）} \tieside{中档}已知正方体\(ABCD\text{-}\penalty100 A_1B_1C_1D_1\)的棱长为\(2\)，\(E\)，\(F\)分别是\(BB_1\)，\(DD_1\)的中点，
\par\vspace{1.9mm}\penalty10000\noindent\makebox[\linewidth][c]{\includegraphics[width=34mm]{figs/js_image40.png}}\par\vspace{-1.0mm}\penalty10000
...
\par\vspace{1.9mm}\penalty10000\noindent\makebox[\linewidth][c]{\includegraphics[width=34mm]{figs/js_image42.png}}\par\vspace{-1.0mm}\penalty10000
...
\par\vspace{1.9mm}\penalty10000\noindent\makebox[\linewidth][c]{\includegraphics[width=26mm]{figs/js_image51.png}\hspace{4mm}\includegraphics[width=26mm]{figs/js_image52.png}}\par\vspace{-1.0mm}\penalty10000
...
\par\vspace{1.9mm}\penalty10000\noindent\makebox[\linewidth][c]{\includegraphics[width=22mm]{figs/js_image50.png}\hspace{4mm}\includegraphics[width=24mm]{figs/js_image48.png}}\par\vspace{-1.0mm}\penalty10000
\lxopt{①三棱锥\(C_1\text{-}\penalty100 PAC\)的体积是定值；}
\par\vspace{1.9mm}\penalty10000\noindent\makebox[\linewidth][c]{\includegraphics[width=24mm]{figs/js_image49.png}}\par\vspace{-1.0mm}\penalty10000
...
\par\vspace{1.9mm}\penalty10000\noindent\makebox[\linewidth][c]{\includegraphics[width=30mm]{figs/dy2_image14.png}}\par\vspace{-1.0mm}\penalty10000
\lxopt{(1)\(CD\perp AE\)；}
