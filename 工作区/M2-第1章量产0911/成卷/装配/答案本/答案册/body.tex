...
% 生成：2026-09-12｜键数：631｜对号契约：每键一行 `%% pair:键`（check_pairs 扫描口径）
...
% pair:导-课时02-判4
% pair:导-课时02-判5
\ansline{答案}{(1)$\times$\quad (2)$\times$\quad (3)$\times$\quad (4)$\times$\quad (5)知识点三(1)$\times$；(2)\(\surd\)}
\vskip 0pt minus 1.2pt
% pair:导-课时02-探1-例1
% pair:导-课时02-探1-变式1
...
\vskip 0pt minus 1.2pt
\ansline{解析}{C 项实算 \(\cos\langle\overrightarrow{B_{1}C},\overrightarrow{AA_{1}}\rangle=-\dfrac{\sqrt{2}}{4}\)（约 \(110.7^{\circ}\)），非 \(120^{\circ}\)——详解 C 项按亲算改字，结论「C 不正确」不变。}
\vskip 0pt minus 1.2pt
% pair:导-课时03-评1
% pair:导-课时03-评2
% pair:导-课时03-评3
...
% pair:导-课时05-预习填空
\ansline{预习填空}{知识点一：\(\lambda b_{1}\)；\(\lambda b_{2}\)；\(\lambda b_{3}\)；\(a_{1}b_{1}+a_{2}b_{2}+a_{3}b_{3}=0\)。知识点二：\(\sqrt{a_{1}^{2}+a_{2}^{2}+a_{3}^{2}}\)；\(\dfrac{\overrightarrow{a}\cdot\overrightarrow{b}}{|\overrightarrow{a}||\overrightarrow{b}|}\)；\(\dfrac{\overrightarrow{a}\cdot\overrightarrow{b}}{|\overrightarrow{b}|}\)。知识点三：\(1-\lambda\)；\(\overrightarrow{AD}\)；互相平分。}
\vskip 0pt minus 1.2pt
% pair:导-课时05-判1
% pair:导-课时05-判2
% pair:导-课时05-判3
...
\qufen{1.2.1 前·几何衔接位}{衔接-1～衔接-29 同号段——五组排布、组内四约束（汇总 §3.2）}
% pair:导-衔接-1
...
\ansline{衔接-14}{证明见解析}
\vskip 0pt minus 1.2pt
\ansline{解析}{外角平分线定理；合比一步补足：\(BD:DC=AB:AC\Rightarrow BD:(BD+DC)=AB:(AB+AC)\)。}
\vskip 0pt minus 1.2pt
% pair:导-衔接-15
...
\ansline{衔接-16}{证明见解析}
\vskip 0pt minus 1.2pt
\ansline{解析}{重心三等分（向量/中位线双链）；取 \(AC\) 中点（源详解「\(BC\)、\(AE\) 的中点」应作 \(AC\)）。}
\vskip 0pt minus 1.2pt
% pair:导-衔接-17
\ansline{衔接-17}{证明见解析}
\vskip 0pt minus 1.2pt
...
\vskip 0pt minus 1.2pt
\ansline{解析}{答案栏按详解栏重建（(2) 即用衔接-20 公式；(3) \(R=\dfrac{abc}{4S}\)）。}
\vskip 0pt minus 1.2pt
% pair:导-衔接-23
...
\vskip 0pt minus 1.2pt
\ansline{解析}{\(AH=2R|\cos A|=BC=2R\sin A\)（\(A\) 钝）\(\Rightarrow A=135^{\circ}\Rightarrow\angle BHC=180^{\circ}-A\)；源同值两制留一制。}
\vskip 0pt minus 1.2pt
% pair:导-衔接-26
...
\vskip 0pt minus 1.2pt
\ansline{解析}{首句按题面改「\(\triangle ABC\) 为等边三角形」（讲部详解误作直角三角形；结果 \(\dfrac{\sqrt{2}}{4}\) 不变）。}
\vskip 0pt minus 1.2pt
% pair:导-课时06-探3-例1
% pair:导-课时06-探3-变式1
...
% pair:导-课时06-评4
% pair:导-课时06-评5
\ansline{评价}{1．A；2．C（\(60^{\circ}\)）；3．C（充要）；4．\(-\dfrac{\sqrt{3}}{3}\)；\(\dfrac{\sqrt{3}}{3}\)；5．\((5,-1,5)\) 或 \((-3,3,-1)\)（写一个即可）}
\vskip 0pt minus 1.2pt
...
\vskip 0pt minus 1.2pt
\ansline{解析}{\(\angle APD=90^{\circ}\)（实算 \(\angle ADP=45^{\circ}\)，结论 \(PD\perp PA\) 仍真）。}
\vskip 0pt minus 1.2pt
\ansline{解析}{求的是平面 \(FAD\) 与平面 \(ADC\) 的夹角（「与」字两处按源件勘正）。}
\vskip 0pt minus 1.2pt
% pair:导-课时09-探2-例1
% pair:导-课时09-探2-变式1
\ansline{探究二}{例1 (1)\(\sqrt{2}\)；(2)\(\dfrac{\sqrt{3}}{2}\)；变式1 \(\dfrac{6\sqrt{13}}{13}\)}
\vskip 0pt minus 1.2pt
\ansline{解析}{方程组路独立可解（不承叉乘法；删法一，仅留法二与题后反思）。}
\vskip 0pt minus 1.2pt
% pair:导-课时09-探3-例1
% pair:导-课时09-探3-变式1
...
\vskip 0pt minus 1.2pt
\ansline{解析}{空间余弦定理先证后用（建系可另证，注记随册）。}
\vskip 0pt minus 1.2pt
% pair:导-课时09-探5-例1
% pair:导-课时09-探5-变式1
...
\vskip 0pt minus 1.2pt
\ansline{解析}{\(AB\parallel DC\)，\(DC\subset\) 平面 \(EFCD\)（源详解衍字已正）；点到面 \(EFCD\) 的距离。}
\vskip 0pt minus 1.2pt
% pair:导-课时10-探4-例1
% pair:导-课时10-探4-变式1
...
\setlength{\anshang}{7.6mm}   % 题 10 起双位档
% pair:练-课时04-10
\ansitem{10}{C（\(\left(2,2,\dfrac{2}{3}\right)\)）}
\vskip 0pt minus 1.2pt
% pair:练-课时04-11
...
\vskip 0pt minus 1.2pt
% pair:练-课时04-13
\ansitem{13}{\(A_{1}(4,1,-1)\)，\(B_{1}(0,0,1)\)，\(C_{1}(-1,-2,0)\)，\(D_{1}(3,-1,-2)\)}
\vskip 0pt minus 1.2pt
% pair:练-课时04-14
\ansitem{14}{①\(\Leftrightarrow\)③（②不作条件，不作结论）}
\vskip 0pt minus 1.2pt
% pair:练-课时04-15
\ansitem{15}{(1)\((x-2)^{2}+(y-2)^{2}=4\)（\(m=12\)），圆，长 \(4\pi\)；(2)\(m=12\) 或 \(16\)；(3)\(|PB_{1}|\in[4,4\sqrt{3}]\)}
\vskip 0pt minus 1.2pt
% pair:练-课时04-16
...
\vskip 0pt minus 1.2pt
% pair:练-课时06-9
\ansitem{9}{(1)\(BC\)、\(CD\)、\(B^{\prime}C^{\prime}\)、\(C^{\prime}D^{\prime}\)；(2)\(60^{\circ}\)／\(120^{\circ}\)／\(90^{\circ}\)}
\vskip 0pt minus 1.2pt
\setlength{\anshang}{7.6mm}   % 题 10 起双位档
% pair:练-课时06-10
\ansitem{10}{证明见解析（\(\overrightarrow{MN}=\dfrac{1}{2}\overrightarrow{B_{1}C}\)）}
\vskip 0pt minus 1.2pt
\ansline{解析}{正方形对角线互相平分——中点 \(M\)、\(N\) 为对角线交点链，且【知识点】按向量口径重标。}
\vskip 0pt minus 1.2pt
% pair:练-课时06-11
...
\vskip 0pt minus 1.2pt
\ansline{解析}{\(\cos\langle\overrightarrow{PD},\overrightarrow{AC}\rangle=\dfrac{\sqrt{2}}{4}\)（等号后补分隔：\(\cos=\dfrac{|\overrightarrow{PD}\cdot\overrightarrow{AC}|}{|\overrightarrow{PD}||\overrightarrow{AC}|}\)）。}
\vskip 0pt minus 1.2pt
% pair:练-课时06-13
\ansitem{13}{\(45^{\circ}\)、\(\dfrac{\sqrt{2}}{2}a\)}
\vskip 0pt minus 1.2pt
\ansline{解析}{\(\cos\langle\overrightarrow{EF},\overrightarrow{AB}\rangle=\dfrac{\overrightarrow{EF}\cdot\overrightarrow{AB}}{|\overrightarrow{EF}||\overrightarrow{AB}|}\)（补分隔）。}
\vskip 0pt minus 1.2pt
% pair:练-课时06-14
...
\ansitem{10}{证明见解析}
\vskip 0pt minus 1.2pt
\ansline{解析}{末句应为 \(DB\cap DM=D\)（源详解「\(DB\cap DM=M\)」勘正）。}
\vskip 0pt minus 1.2pt
% pair:练-课时07-11
\ansitem{11}{(1)(2) 证明见解析}
\vskip 0pt minus 1.2pt
\ansline{解析}{法向量共线 \(\Rightarrow\) 平行或重合——补「两平面不重合」完备句。}
\vskip 0pt minus 1.2pt
% pair:练-课时07-12
...
\vskip 0pt minus 1.2pt
\ansline{解析}{二面角定义法前序合法（基准表第18行判例）。}
\vskip 0pt minus 1.2pt
% pair:练-课时08-9
...
\vskip 0pt minus 1.2pt
\ansline{解析}{方法二「平面 \(QDC\)」（源详解「平面 \(QOC\)」勘正；值无误）。}
\vskip 0pt minus 1.2pt
% pair:练-课时08-11
...
\vskip 0pt minus 1.2pt
\ansline{解析}{(2) 印钝制 \(-\dfrac{2\sqrt{7}}{7}\)（取锐 \(\dfrac{2\sqrt{7}}{7}\) 两制并存挂账——教材 PDF 无答案栏，钉-7 保持待钉并呈报）。}
\vskip 0pt minus 1.2pt
% pair:练-课时09-8
...
\vskip 0pt minus 1.2pt
\ansline{解析}{\(ACD_{1}\) 面 \(x-2y+2z=0\)，\(d=\dfrac{1}{3}\)；「y 轴」两处按源件勘正。}
\vskip 0pt minus 1.2pt
% pair:练-课时10-3
\ansitem{3}{A（\(\dfrac{2\sqrt{2}}{3}\)）}
\vskip 0pt minus 1.2pt
\ansline{解析}{\(|\overrightarrow{BA}\times\overrightarrow{BC}|=2\sqrt{2}\)、\(|BC|=3\)；向量坐标不加模线（源详解勘正）。}
\vskip 0pt minus 1.2pt
% pair:练-课时10-4
...
\ansitem{12}{BC}
\vskip 0pt minus 1.2pt
\ansline{解析}{D 项应为 \(\dfrac{5}{6}\)（源详解嵌套绝对值与括号错位勘正）。}
\vskip 0pt minus 1.2pt
% pair:练-课时10-13
...
\vskip 0pt minus 1.2pt
\qufen{六、1.2.3 域}{拓-051～058（057 撤下）}
% pair:拓-051
\ansitem{051}{\(45^{\circ}\)}
\vskip 0pt minus 1.2pt
% pair:拓-052
...
\vskip 0pt minus 1.2pt
% pair:拓-053
\ansitem{053}{\(\left(\dfrac{1}{2},1\right)\)}
\vskip 0pt minus 1.2pt
% pair:拓-054
...
\vskip 0pt minus 1.2pt
\qufen{八、1.2.5 域}{拓-080～160（057 已撤，域外不涉）}
% pair:拓-080
