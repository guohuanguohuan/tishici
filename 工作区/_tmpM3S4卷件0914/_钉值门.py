...
EXPECT = {
 ...
 '滚A': {
  ...
  '2章-滚A-5': '45', '2章-滚A-6': 'x^{2}+y^{2}-2x+2y-3=0', '2章-滚A-7': 'D（',
  '2章-滚A-8': 'ACE', '2章-滚A-9': 'ACD', '2章-滚A-10': BS + 'dfrac{9}{4}',
  '2章-滚A-11': BS + 'dfrac{13}{5}', '2章-滚A-12': BS + 'dfrac{' + BS + 'sqrt{2}}{2}',
  '2章-滚A-13': '3x+2y+1=0', '2章-滚A-14': '3', '2章-滚A-15': '-1\leq a\leq', '2章-滚A-16': '2' + BS + 'sqrt{51}',
 },
 '滚B': {
  '2章-滚B-1': 'B', '2章-滚B-2': '4+' + BS + 'sqrt{3}', '2章-滚B-3': 'x^{2}+y^{2}-4x-2y-20=0',
  '2章-滚B-4': 'C', '2章-滚B-5': '(2,2)', '2章-滚B-6': 'A（', '2章-滚B-7': 'C',
  '2章-滚B-8': 'ACD', '2章-滚B-9': 'AD', '2章-滚B-10': '\dfrac{y^{2}}{4}=1', '2章-滚B-11': 'y^{2}=2x',
  '2章-滚B-12': '4', '2章-滚B-13': 'y^{2}=8x', '2章-滚B-14': 'p=1', '2章-滚B-15': BS + 'dfrac{4}{3}',
  '2章-滚B-16': 'm=1',
 },
}
    ...
    for k, w in want.items():
        ...
        for ln in body.splitlines():
            ...
            if t.startswith(chr(92) + 'ansitem{'):
                ...
                got = t[j2 + 1: t.rfind('}')]
                break
        if got is None or w.replace(' ', '') not in got.replace(' ', ''):
