...
\jpthree{\jphead
  ...
  \optline{\optIV{A．\(\overrightarrow{BD}+\overrightarrow{DA}\)；}{B．\(\overrightarrow{AB}-\overrightarrow{AC}\)；}{C．\(\overrightarrow{BC}+\overrightarrow{CD}+\overrightarrow{DA}+\overrightarrow{AB}\)；}{D．\(\overrightarrow{BC}+\overrightarrow{BD}\)．}}
}{\jplead
