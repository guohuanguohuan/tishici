...
%   heihao 700→NSC-w500（检测题号数字 6px@11.4，全角「．」随 w500 同族）；
...
\setCJKfamilyfont{heihao}[Path=fonts/,BoldFont=NSC-w500.ttf]{NSC-w500.ttf}
...
% \numbold 条目号数字 w850（8px@10.09）；\numboldjian 检测题号数字 w500（6px@11.4）——
...
\newfontfamily{\numboldjian}[Path=fonts/,Height=0.905,Depth=0.212]{NSC-w500.ttf}
