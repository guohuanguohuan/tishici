...
\newcommand{\tiaomu}[2]{\par\glueguard{1}\noindent{\heitiao \textbf{#1}.}\hspace{1em}#2\par\addvspace{1.8mm}}
% 编注/注记 run（拍板1：[注意] 题源标式内联前缀——半角[]、宋体常规、正文同号；同段接排）
\newcommand{\zhuzhu}[1]{\hspace{0.5em}[注意]\hspace{0.4em}#1}
...
\newcommand{\tjdnr}[5]{\par\glueguard{2}\addvspace{3pt}%
  \noindent{\fontsize{12pt}{17pt}\selectfont\heibf \huafu\hspace{2.4mm}探究点#1\hspace{2em}#2}\par
  \addvspace{2.0mm}%
  \nopagebreak\noindent{\fontsize{12pt}{15pt}\selectfont\lihei\lilat #3}%
  \hspace{2.7mm}\tieside{#4}\hspace{2.2mm}#5\par}
% 例题/变式（非点首）：标签（变式1）＋题侧［难度（知识点N）］＋题干（顶格）；
% 变式标签 12pt \heiti（拍板4a 标签层降档＝FZHei 常规，本底补差）；题侧 10.5pt 黑（TJ-03）；
% 标签→题侧 2.7mm、题侧→题干 2.2mm（TJ-03 隙距）
\newcommand{\li}[4]{\par\glueguard{2}\addvspace{2pt}%
  \noindent{\fontsize{12pt}{15pt}\selectfont\lihei\lilat #1}%
