...
%   案B 附卷制：答案迁卷末附卷、逐题 % ans: 锚、速查表纯题档 \ifshowans 吞、
...
\newcommand{\dabiao}{%
  ...
  答案 & A & C & A & C & A & B & A & A & AB & BCD & BCD & \(y=1\) & \((x-1)^{2}+y^{2}=4\) & \(1+\sqrt{3}\) & 略 & 略 & 略 & 略 & 略 \\ \hline
  \end{tabular}}\par}
...
\newpage
% ===================== 第 3 页：栏1 Q16–Q17；栏2 Q18–Q19；栏3 Q19 续＋答案速查表 =====================
\jpthree{\jplead
  ...
  \anskey{2章-测-1}\anskey{2章-测-2}\anskey{2章-测-3}\anskey{2章-测-4}\anskey{2章-测-5}\anskey{2章-测-6}\anskey{2章-测-7}\anskey{2章-测-8}\anskey{2章-测-9}\anskey{2章-测-10}\anskey{2章-测-11}\anskey{2章-测-12}\anskey{2章-测-13}\anskey{2章-测-14}\anskey{2章-测-15}\anskey{2章-测-16}\anskey{2章-测-17}\anskey{2章-测-18}\anskey{2章-测-19}
  \fi
}
...
\newpage
\jpthree{\jplead
  \par\vskip 2.0mm\noindent{\fontsize{\qpJTfSize}{17.7pt}\selectfont\heitiao 参考答案}\hspace{0.6em}{\fontsize{\qpJTeSize}{17.7pt}\selectfont（单元素养测评卷（二）·含详解档）}\par\nopagebreak
