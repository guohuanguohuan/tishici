# -*- coding: utf-8 -*-
"""一次性脚本（E4讲练C）——PDF前2页导出（COM ExportAsFixedFormat FromTo）＋Quit"""
import win32com.client, pythoncom, os, sys

src = r"C:\提示词\工作区\同步-数学选必1册改制轮-0901\E执行\E4讲练C\工作\C_同串.docx"
out = r"C:\提示词\工作区\同步-数学选必1册改制轮-0901\E执行\E4讲练C\工作\C_同串_前2页.pdf"
