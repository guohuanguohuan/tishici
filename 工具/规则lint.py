...
WHITELIST = {
    ...
    "XJ-1c": [
        ...
        # ⑪轮 B 组定性后主会话裁决回填（工作区/批量小任务-0906/⑪_终报B.md §七 C1-C15＋第16条；
        # 均 clause 作用域、片段经 ⑪ 轮实测在本件内唯一；语义＝现行机制叙述/非留痕语义，不标▽）
        ("公共规则.md", "整轮作废触发三类必过门", "clause"),
        ("公共规则.md", "该批结论作废换新代理重验", "clause"),
        ("公共规则.md", "前提错则方案作废重估", "clause"),
        ("公共规则·目录摘要.md", "深蓝字废止", "clause"),
        ("公共规则·目录摘要.md", "落选题清单已废止", "clause"),
        ("公共规则·目录摘要.md", "旧打印本作废", "clause"),
        ("公共规则·目录摘要.md", "异族前提废止", "clause"),
        ("附则/双栏首页断言.md", "任一回修触发即作废其后全部盖章", "clause"),
        ("附则/故障先修纪律.md", "重跑作废品由主会话清点登记", "clause"),
        ("附则/故障先修纪律.md", "产物作废面按断点续跑条款清点", "clause"),
        ("附则/讲练件底纹减法.md", "不改本行「衔接件不适用四类废止」的适用范围判定", "clause"),
        ("附则/讲练件底纹减法.md", "不入四类废止", "clause"),
        ("附则/跨脑复审计制.md", "仍不满足记skip（2026-09-06 外部 CLI 退役后无顺延臂）", "clause"),
        ("附则/跨脑复审计制.md", "才记skip（2026-09-06 外部 CLI 退役后独存臂", "clause"),
        ("附则/跨脑复审计制.md", "抽验重测不合格即整轮自检记录作废重跑", "clause"),
        ("公共规则.md", "CLI 时代调用全式与逐轮核验法于附则《多脑调用登记》K1 留痕", "clause"),
    ],
    "XJ-1d": [
